...
import { Mail, Lock, Eye, EyeOff, ArrowRight, ShoppingBag, Truck, ShopCheck } from 'lucide-react';
          ...
          <div className="max-w-sm mx-auto">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded focus:ring-2 focus:ring-[#2874F0] focus:border-[#2874F0]"
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 space-y-3">
                <button className="w-full py-2.5 border border-gray-300 rounded flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors">
