...
export default function Home() {
  ...
  const c = { maxWidth: 1280, margin: '0 auto', padding: isMobile ? '0 16px' : '0 40px' }
  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'var(--surface)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ ...c, display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 48, alignItems: 'center', padding: isMobile ? '32px 16px' : '72px 40px', position: 'relative' }}>
          <div style={{ animation: 'fadeUp 0.5s ease' }}>
            ...
            <h1 style={{ fontSize: isMobile ? 32 : 56, fontWeight: 800, lineHeight: 1.08, letterSpacing: '-0.04em', color: 'var(--text)', marginBottom: 8 }}>
              Discover Amazing<br />
              <span style={{ color: 'var(--primary)' }}>Products</span>
            </h1>
            <p style={{ fontSize: isMobile ? 14 : 17, color: 'var(--text2)', lineHeight: 1.7, maxWidth: isMobile ? '100%' : 460, marginBottom: 36, marginTop: 16 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            {/* Float badge */}
            <div style={{ position: 'absolute', bottom: 20, right: 20, background: 'rgba(255,255,255,0.96)', backdropFilter: 'blur(12px)', border: '1px solid var(--border)', borderRadius: 16, padding: '14px 18px', boxShadow: 'var(--shadow-lg)', display: isMobile ? 'none' : 'flex', alignItems: 'center', gap: 12 }}>
      ...
      <div style={{ background: 'var(--surface)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
        <div style={{ ...c, display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3,1fr)' }}>
          {[
      ...
      {/* Categories */}
      <section style={{ ...c, padding: isMobile ? '32px 16px' : '64px 40px' }}>
      ...
      {/* Promo banners */}
      <section style={{ ...c, padding: isMobile ? '0 16px 32px' : '0 40px 64px', display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 16 }}>
